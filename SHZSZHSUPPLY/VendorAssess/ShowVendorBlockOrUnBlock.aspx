    ...
    <div style="text-align:right" class="auto-style12">PR-05-07-04</div><br>
        <table style="margin: auto; border-collapse:initial" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan="1" style="text-align:left" class="auto-style6"><asp:TextBox ID="TextBox1" runat="server" CssClass="t" Height="35px" ReadOnly="true" ></asp:TextBox></td>
            </tr>

            <tr>
                <td colspan="1" style="text-align:left" class="auto-style3">申请人姓名*</td>
                <td colspan="1" style="text-align:left" class="auto-style6"><asp:TextBox ID="TextBox2" runat="server" CssClass="auto-style10" Height="35px" Width="452px" ReadOnly="true"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="1" style="text-align:left" class="auto-style6"><asp:TextBox ID="TextBox9" runat="server" CssClass="auto-style11" Height="35px" Width="461px" ReadOnly="true"></asp:TextBox></td>
            </tr>
            <tr>
