...
namespace DAL.VendorAssess
{
    public class ServiceComponentApplication_DAL
    {
        ...
        {
            string sql = "insert into As_Vendor_ServiceComponentApplication(Form_Type_ID,Temp_Vendor_ID,Temp_Vendor_Name,Flag,Factory_Name)values(@Form_Type_ID,@Temp_Vendor_ID,@Temp_Vendor_Name,@Flag,@Factory_Name)";
