...
<head runat="server">
    ...
    <script>
        layui.use(['form', 'layedit', 'laydate'], function () {
            ...
            $("div[class='layui-unselect layui-form-radio layui-form-radioed']:nth-child(2)").html = 'kg';
            $("div[class='layui-unselect layui-form-radio']:nth-child(2)").val = 'kgs';
...
<body>
    <form id="form1" class="layui-form" runat="server">
        <fieldset class="layui-field-title layui-elem-field" style="margin: 50px 0 auto; width: 1000px;">
