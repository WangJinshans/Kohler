...
namespace DAL.VendorAssess
{
    public class FormReject_DAL
    {
        ...
        {
            string sql = "insert into As_FormAsscess_Reject(Form_ID,Temp_Vendor_ID)values('" + form.Form_ID + "','" + form.Temp_Vendor_ID + "')";
        ...
        {
            string sql = "select Form_ID from As_FormAsscess_Reject where Form_ID='" + form.Form_ID + "'";
