<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VendorBlockOrUnBlock.aspx.cs" Inherits="SHZSZHSUPPLY.VendorAssess.VendorBlockOrUnBlock" %>
    ...
    <form id="form1" runat="server">
        ...
        <table style="margin: auto; border-collapse:initial" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td colspan="1" style="text-align:left" class="auto-style6"><asp:TextBox ID="TextBox6" runat="server" CssClass="auto-style11" Height="35px"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="1" style="text-align:left" class="auto-style6"><asp:TextBox ID="TextBox9" runat="server" CssClass="auto-style11" Height="35px"></asp:TextBox></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1" style="text-align:left" class="auto-style3">经查，供应商的AP余额已为零</td>
        ...
        <asp:Button ID="Button3" runat="server" Text="返回" OnClick="Button3_Click" style="height: 21px" />
        </div>
        <div>
