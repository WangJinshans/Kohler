    ...
    <form id="form1" runat="server">
        <div>
            <table style="margin: auto; border-collapse: collapse; width: 1000px">
                ...
                <tr>
                    <td colspan="2">名次</td>
                    <td><asp:TextBox TextMode="MultiLine" runat="server" ID="TextBox50" CssClass="t"></asp:TextBox></td>
                    <td><asp:TextBox TextMode="MultiLine" runat="server" ID="TextBox51" CssClass="t"></asp:TextBox></td>
                    <td><asp:TextBox TextMode="MultiLine" runat="server" ID="TextBox52" CssClass="t"></asp:TextBox></td>
                    <td><asp:TextBox TextMode="MultiLine" runat="server" ID="TextBox53" CssClass="t"></asp:TextBox></td>
                </tr>
                <tr>
