...
<body class ="body" onload ="IFrameResize()" >
 ...
 <tr><td style=" font-size :small; font-family :Arial ">供应商-工厂：.</td></tr></table></div>
 <div class="div2" style="height:80px">
    ...
    <table cellpadding ="0" cellspacing ="0" class="div1" style="height:20px"><tr><td style=" font-size :small; font-family :Arial ">上传文档：</td></tr></table></div>
    <div class="div2" style="height:20px">
    <table cellpadding ="0" cellspacing ="0" class="div2" style="height:20px"><tr><td style=" font-size :small; font-family :Arial ">必选文档：</td></tr></table></div>
...
<ControlStyle BorderWidth="0px" Height="20px" Width="20px"></ControlStyle>
    ...
    <div class="leftdiv" style="height:100%"></div>
    <div class="rightdiv" style="height:100%"><table cellpadding ="0" cellspacing ="0"><tr><td class="rightdiv"  style=" font-size :small; height :20px ">已上传文档清单：</td></tr></table></div>
    <div class="leftdiv" style="height:100%"></div>
    <div class="rightdiv" style="height:100%">
            ...
            <ContentTemplate>
            <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="White" >[LinkButton]</asp:LinkButton>
         ...
         <asp:Panel ID="Panel3" runat="server" CssClass ="panel1" BackColor="#CCCCCC" 
            ...
            <tr>
            <td style="height:25px; width :300px; background-color :#666633; font-size:medium  ; text-align :center">有效期编辑</td></tr>
            </table>
