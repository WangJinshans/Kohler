    ...
    <form id="form1" class="layui-form" runat="server">
        ...
        <div style="width:1000px;margin:0 auto">
            ...
            <div style="width:495px;float:right">
                <fieldset id="Fieldset1" runat="server" class="layui-elem-field layui-field-title" style=" margin: 50px auto 20px auto;">
                    <legend>待提交表格</legend>
                </fieldset>
                <asp:GridView Style=" margin: 0 auto" class="layui-table" lay-even="" lay-skin="nob" ID="GridView5" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView5_RowCommand" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                    <Columns>
                        <asp:BoundField DataField="Temp_Vendor_Name" HeaderText="供应商名称"
                            SortExpression="Temp_Vendor_Name" />
                        <asp:BoundField DataField="Form_Type_Name" HeaderText="表格名称"
                        ...
                        <asp:TemplateField HeaderText="编辑">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtFormStatus" runat="server" CommandName="deleteForm"
                                    CommandArgument='<%# Eval("Form_ID") %>' Text="删除表格"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton OnClientClick="waiting('正在加载')" ID="lbtShowDetails" runat="server" CommandName="keepFilling"
                                    CommandArgument='<%# Eval("Form_Type_ID") %>'>继续填写</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
